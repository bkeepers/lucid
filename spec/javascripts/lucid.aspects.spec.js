  ...
  describe('before', function() {
    describe('with methods on the object', function() {
      ...
      beforeEach(function() {
        ...
        object.before('foo', function() { this.calls.push('before'); });
      });
      ...
      it('should fire multiple', function() {
        object.before('foo', function() { this.calls.push('again'); });
        object.foo();
    ...
    describe('with methods on the prototype', function() {
      ...
      beforeEach(function() {
        ...
        O.prototype.before('foo', function() { this.calls.push('before'); });
      });
      ...
      it('should fire multiple', function() {
        O.prototype.before('foo', function() { this.calls.push('again'); });
        object.foo();
        expect(object.calls).toEqual(['again', 'before', 'foo']);
      });
  ...
  describe('after', function() {
    describe('with methods on the object', function() {
      ...
      beforeEach(function() {
        ...
        object.after('foo', function() { this.calls.push('after'); });
      });
      ...
      it('should fire multiple', function() {
        object.after('foo', function() { this.calls.push('again'); });
        object.foo();
    ...
    describe('with methods on the prototype', function() {
      ...
      beforeEach(function() {
        ...
        O.prototype.after('foo', function() { this.calls.push('after'); });
      });
      ...
      it('should fire multiple', function() {
        O.prototype.after('foo', function() { this.calls.push('again'); });
        object.foo();
        expect(object.calls).toEqual(['foo', 'after', 'again']);
      });
